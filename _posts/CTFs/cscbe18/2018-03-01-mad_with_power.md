---
layout: posts
title:  CSCBE18 - Water you talking about / Mad with power
date:   2018-03-01
...
![hydropump](/assets/res/CTFs/cscbe18/mad_with_power/hydropump.png)
...
The first thing to do is to sign in as the developer, who has admin privileges. To do this, we sent random credentials and hit the sign-in button, and we intercepted the response with Burp.
In the body, we found the Lucas' credentials: `<!-- DEV: lucas:devpwd -->`
![admin](/assets/res/CTFs/cscbe18/mad_with_power/admin_panel.png)
