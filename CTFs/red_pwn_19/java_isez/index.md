...
We were given a single [Java class file](JavaIsEZ.class), that could not be properly decompiled by our old friend jd-gui (v1.6) which only displays:
...
or version 1.4 which prints some bytecode, but was not really useful. Fortunately, [online version of Procyon](http://www.javadecompilers.com/) did the job quite well (result [here](JavaIsEZ_dec.class)):
